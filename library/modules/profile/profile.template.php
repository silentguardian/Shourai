		...
		<form class="form-horizontal" action="', build_url('profile'), '" method="post">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<span class="input-xlarge uneditable-input" id="generation">', $template['profile']['generation'], '</span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="section">Section:</label>
					<div class="controls">
						<span class="input-xlarge uneditable-input" id="section">', $template['profile']['section'], '</span>
					</div>
				</div>
				<div class="control-group">
